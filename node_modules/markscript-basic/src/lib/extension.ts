...
export interface Extension {
  ...
  post?(context: Context, params: Parameters, input: DocumentNode<any>|ValueIterator<any>)

  put?(context: Context, params: Parameters, input: DocumentNode<any>|ValueIterator<any>)
